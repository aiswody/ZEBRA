  ...
  return (
    <div className="flex flex-col h-screen bg-gray-100 font-sans">
      <header className="bg-white shadow-sm p-4 flex items-center sticky top-0 z-10">
        ...
        <div className="flex items-center mx-auto">
          <Bot className="text-indigo-600 mr-2" size={28}/>
          <h1 className="text-xl font-bold text-gray-800">AI 감축 방안 분석 (테스트 모드)</h1>
        </div>
        <div className="w-10"></div>
      </header>
      <main className="flex-1 p-4">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-2xl font-bold text-green-600 mt-10">✅ 테스트 페이지가 성공적으로 보입니다!</h2>
          <p className="mt-4 text-gray-700">
            이제 이 페이지가 정상적으로 보였으니, 다음 단계로 넘어갈 수 있습니다.
            <br />
            API 호출 로직을 다시 추가해서 문제를 해결해 보겠습니다.
          </p>
        </div>
      </main>
    </div>
