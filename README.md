...
> 2025 미래청년 사업(한전 MCS 청년일경험) 결과보고회 1위 수상 프로젝트를 개인적으로 fork하여
> 계속 유지보수하고 있는 저장소입니다.
...
동국대학교 컴퓨터AI학부 「2025 미래청년 사업(한전 MCS 청년일경험)」 11조 팀 프로젝트로 시작되었으며,
결과보고회에서 1위를 수상했습니다. 이 저장소는 원본 팀 프로젝트를 개인 계정으로 fork하여
계속 유지보수하는 버전입니다.
